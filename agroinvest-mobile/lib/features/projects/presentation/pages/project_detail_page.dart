          ...
          : provider.error != null
              ? Center(
                  child: Padding(
                    ...
                    child: Text(provider.error!, style: const TextStyle(color: AppColors.danger, fontWeight: FontWeight.bold)),
                  ),
                )
  ...
  Widget _buildDetails(Map<String, dynamic> p) {
    ...
    return Column(
      children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          getAssetLabel(p['assetType']?.toString() ?? 'OTHER'),
        ...
        // Bottom actions area
        _buildBottomActions(auth, isFunding),
      ],
    );
  }

  Widget _buildBottomActions(AuthProvider auth, bool isFunding) {
      ...
      return Container(
        ...
        child: ElevatedButton.icon(
          onPressed: () => Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => SubmitReportPage(projectId: widget.projectId),
            ),
          ),
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (val) {
                    ...
                    if (num == null || num <= 0) return 'Musbat summa kiriting';
                    return null;
                  },
                ),
                const SizedBox(height: 24),
