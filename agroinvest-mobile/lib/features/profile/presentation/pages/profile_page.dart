...
import '../../../investments/presentation/pages/my_investments_page.dart';
import '../../../projects/presentation/pages/my_projects_page.dart';
import '../../../kyc/presentation/pages/kyc_page.dart';
import '../../../disputes/presentation/pages/disputes_page.dart';
    ...
    return Column(
      ...
      children: [
        ...
        _buildMenuButton(
          ...
          label: 'Shikoyatlarim',
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => const DisputesPage()));
          },
        ),
